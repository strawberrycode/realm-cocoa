...
class ListTests: TestCase {
    ...
    func testMove()  {
        ...
        XCTAssertEqual(children[0].stringCol, "2");
        XCTAssertEqual(children[1].stringCol, "1");

        array.move(from: 0, to: 1)

        XCTAssertEqualObjects(children[0].stringCol, "1");
        XCTAssertEqualObjects(children[1].stringCol, "2");
